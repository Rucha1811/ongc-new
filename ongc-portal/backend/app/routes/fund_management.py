...
COLUMN_SYNONYMS = {'head': ['head', 'category', 'budget head', 'expense head', 'item'], 'allocated': ['allocated', 'budget', 'allocation', 'approved'], 'spent': ['spent', 'expenditure', 'utilized', 'actual'], 'remaining': ['remaining', 'balance', 'left', 'unspent']}
